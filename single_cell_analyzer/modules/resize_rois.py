...
def main():
    ...
    parser.add_argument('--macro', default='single_cell_analyzer/macros/resize_rois.ijm',
                        help='Path to the dedicated ImageJ macro file (default: single_cell_analyzer/macros/resize_rois.ijm)')

"""Unit tests for configuration classes before refactoring."""
import json
import pytest
...
class TestConfig:
    ...
    def test_save_creates_directory(self, tmp_path: Path):
        ...
        # Create initial file to avoid ConfigError
...
class TestConfigErrorHandling:
    ...
    @patch('percell.application.config_api.json.loads')
    ...
    def test_save_io_error_raises_config_error(self, tmp_path: Path):
        ...
        with pytest.raises(ConfigError, match="Error saving configuration"):
            config.save()
...
class PathConfig:
    ...
    def _initialize_paths(self) -> Dict[str, Path]:
        ...
        return {
            ...
            "analyze_cell_masks_module": root / "modules" / "analyze_cell_masks.py",

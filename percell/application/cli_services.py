...
def show_configuration_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Set Input/Output Directories', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Data Selection (conditions, regions, timepoints, channels)', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}3.{Colors.reset} {colorize('Check Current Configuration', Colors.blue)}")
...
def show_workflows_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Run Complete Workflow', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Advanced Workflow Builder (custom sequence of steps)', Colors.yellow)}")
...
def show_processing_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Process Single-cell Data (tracking, resizing, extraction, grouping)', Colors.yellow)}")
...
def show_segmentation_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Cellpose Single-cell Segmentation', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Back to Main Menu', Colors.red)}")
    ui.info("")
    ui.info("")
    ui.info("")
...
def show_analysis_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Threshold Grouped Cells (interactive ImageJ thresholding)', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Measure Cell Area (measure areas from single-cell ROIs)', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}3.{Colors.reset} {colorize('Analysis (combine masks, create cell masks, export results)', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}4.{Colors.reset} {colorize('Back to Main Menu', Colors.red)}")
    ui.info("")
    ui.info("")
    ui.info("")
...
def show_utilities_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Cleanup (empty cells and masks directories, preserves grouped/combined data)', Colors.reset)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Back to Main Menu', Colors.red)}")
    ui.info("")
    ui.info("")
    ui.info("")
...
def show_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset}  {colorize('Configuration', Colors.reset)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset}  {colorize('Workflows', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}3.{Colors.reset}  {colorize('Segmentation', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}4.{Colors.reset}  {colorize('Processing', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}5.{Colors.reset}  {colorize('Tracking', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}6.{Colors.reset}  {colorize('Visualization', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}7.{Colors.reset}  {colorize('Analysis', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}8.{Colors.reset}  {colorize('Plugins', Colors.yellow)}")
    ui.info(f"{Colors.bold}{Colors.white}9.{Colors.reset}  {colorize('Utilities', Colors.reset)}")
    ui.info(f"{Colors.bold}{Colors.white}10.{Colors.reset} {colorize('Exit', Colors.red)}")
    ui.info("")
    ui.info("")

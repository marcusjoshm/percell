...
def show_configuration_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Data Selection', Colors.yellow)} {colorize(' - Select conditions, timepoints, regions, and channels for analysis', Colors.reset)}")
    ui.info(f"{Colors.bold}{Colors.white}3.{Colors.reset} {colorize('Current Configuration', Colors.yellow)} {colorize(' - View current input/output directories and data selection', Colors.reset)}")
...
def show_workflows_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Default Workflow', Colors.yellow)}{colorize(' - Complete sequence of steps from segmentation to particle analysis', Colors.reset)}")
    ui.info(f"{Colors.bold}{Colors.white}2.{Colors.reset} {colorize('Advanced Workflow Builder', Colors.yellow)}{colorize(' - Select specific steps to include in a custom workflow', Colors.reset)}")
...
def show_analysis_menu(ui: UserInterfacePort, args: argparse.Namespace) -> Optional[argparse.Namespace]:
    ...
    ui.info("")
    ui.info(f"{Colors.bold}{Colors.white}1.{Colors.reset} {colorize('Threshold Grouped Cells', Colors.yellow)}{colorize(' - interactive Otsu autothresholding of intensity grouped cell data with imageJ', Colors.reset)}")
